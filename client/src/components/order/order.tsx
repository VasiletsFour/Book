...
class Order extends Component<any, { book: any, qunity: number, dispatch: any }>{
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div>
                            <p>QTY:</p>
                            <form action="">
                                <input type="number" min="1" max="10" value={this.state.qunity} onChange={this.handleChangeQunity} placeholder="Your email" />
                            </form>
                            <p>{this.props.book["price"] * this.state.qunity}</p>
                            {this.props.role === "user" ?
                                <button onClick={this.handeleClickAdd}>add to cart</button> : null
                            }</div>
                    </div>
                </div>
            </div>
