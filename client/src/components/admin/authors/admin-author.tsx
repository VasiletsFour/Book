...
class Author extends Component<any, { token: any, err: any, isLoaded: any, authors: any, renameAuthor: boolean, author_id: string, author_name: string, newAuthor: any }> {
    ...
    render() {
        ...
        return (
            <div>
                <Baner url={"http://localhost:8800/admin/author-find"} page={"Authors"} dataFoo={this.handleAuthor} />
