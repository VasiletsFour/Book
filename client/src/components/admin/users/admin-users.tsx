...
class User extends Component<any, { token: any, err: any, isLoaded: any, users: any }> {
    ...
    render() {
        ...
        return (<div><Baner url={"http://localhost:8800/admin/findUser"}  page={"User"} dataFoo={this.handleUser} />
