...
class AdminBook extends Component<any, { token: any, err: any, isLoaded: any, books: any, renameBook: boolean }> {
    ...
    render() {
        ...
        return (
                    <div>
                        <Baner url={"http://localhost:8800/books/sort"} page={"Books"} dataFoo={this.handleBook} />
